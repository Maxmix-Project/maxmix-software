...
// Try avoiding 115200 or 230400 baud rates as Atmega328p leaves not much recovery headroom at these baud rates, especially for arduino clones.
...
static const uint8_t PIXELS_BRIGHTNESS = 96; // Master brightness of all the pixels. [0..255] Be careful of the current draw on the USB port.
...
static const uint32_t DEVICE_RESET_AFTER_INACTIVITY = 5000;
